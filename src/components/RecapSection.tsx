      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <div className="relative">
            {/* Truck art frame stamp - Top Left (Pop-out outside the frame) */}
            <div className="absolute -top-3 -left-3 md:-top-5 md:-left-5 w-12 h-12 md:w-16 md:h-16 bg-midnight-indigo border-2 border-convergence-magenta flex items-center justify-center rotate-3 z-30 shadow-2xl transition-all duration-300 pointer-events-none">
              <div className="border border-silver/30 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center transform -rotate-3">
                ...
                <span className="font-mono text-xs md:text-sm text-convergence-magenta font-semibold">{activeSlide.year}</span>
              </div>
            </div>

            {/* Category stamp: data label — Space Mono (Pop-out outside the frame) */}
            <div className="absolute -bottom-3 -right-3 md:-bottom-5 md:-right-5 px-4 py-2 md:px-6 md:py-3 bg-midnight-indigo border-2 border-vermillion-red z-30 shadow-2xl transform -rotate-2 transition-all duration-300 pointer-events-none">
              <span className="font-mono text-xs md:text-sm text-silver uppercase tracking-wider font-semibold">{activeSlide.category}</span>
            </div>
