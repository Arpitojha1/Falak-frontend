  ...
  return (
    ...
    >
      ...
      {!isExpanded && (
        <>
          {/* ══════════════════════════════════════════════════════════════
              MOBILE COLLAPSED TILE — portrait asset, 3:4, zone layout
              (hidden md+)
              ══════════════════════════════════════════════════════════════ */}
          <div
          ...
          >
            {/* LAYER 0 — portrait stamp-card, object-cover fill, no letterbox.
                layoutId persists through the expand FLIP transition on mobile. */}
            <motion.img
              layoutId={`ticket-frame-mobile-${event.id}`}
            ...
            {/* LAYER 1 — hover tint overlay (same logic as desktop) */}
            <div
              aria-hidden="true"
          ...
          {/* ══════════════════════════════════════════════════════════════
              DESKTOP COLLAPSED TILE — original 8:3 landscape layout unchanged
              (hidden below md)
              ══════════════════════════════════════════════════════════════ */}
          <div className="relative w-full hidden md:block" style={{ aspectRatio: '8 / 3', minHeight: '120px' }}>
            ...
            <motion.img
              layoutId={`ticket-frame-desktop-${event.id}`}
      ...
      {isExpanded && (
        ...
        >
          {/* LAYER 0 — stamp-card asset, same layoutId as whichever collapsed tile was active.
              ...
              On mobile: portrait asset + mobile layoutId suffix.
              On desktop: landscape asset + desktop layoutId suffix.
              objectFit: fill stretches the asset to the new container shape. */}
          <motion.img
            layoutId={isMobile ? `ticket-frame-mobile-${event.id}` : `ticket-frame-desktop-${event.id}`}
            src={isMobile ? '/assets/culturalAssets/stamp-card-portrait.jpg' : '/assets/culturalAssets/stamp-card.png'}
            alt=""
            aria-hidden="true"
            draggable="false"
            className="absolute inset-0 w-full h-full pointer-events-none select-none"
